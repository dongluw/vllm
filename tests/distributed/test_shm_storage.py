...
class TestSingleWriterShmObjectStorage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ring_buffer = SingleWriterShmRingBuffer(
            data_buffer_size=1024 * 100, create=True  # 10 MB buffer
        )
    ...
    def tearDown(self):
        ...
        # Clean up shared memory if possible
        try:
            if hasattr(self.storage.ring_buffer, "cleanup"):
                self.storage.ring_buffer.cleanup()
        except:
            pass
    ...
    def test_various_data_types(self):
        ...
        test_cases = [
            ...
            ("dict_key", {"name": "Alice", "age": 30, "scores": [95, 87, 92]}),
    ...
    def test_put_same_key_twice(self):
        ...
        # data will not be overwritten for the same key, should still be the first value
...
def reader_process(process_id, storage_handle, items_to_read):
    ...
    print(
        f"Reader {process_id} started with storage (writer: {reader_storage.is_writer})"
    )
